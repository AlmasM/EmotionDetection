...
unknownDir = '/Users/almas/Documents/Research/face_recog/unknown_images/'
...
def get_unknown_chars(path_un):
	...
	if face_locations != []:
		...
		pil_image.save(path_un.split("unknown_images/", 1)[1])
...
get_directory()
get_unknown_directory()
# print(char_known_faces[0])
